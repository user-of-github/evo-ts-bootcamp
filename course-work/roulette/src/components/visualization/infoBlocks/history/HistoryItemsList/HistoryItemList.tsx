...
import {EMPTY_HISTORY_TEXT} from '../../../../../utilities/configuration'
...
export const HistoryItemList = observer(
    (props: { story: Array<ResultsHistoryItem>, modalsState: ModalsController }): JSX.Element => (
